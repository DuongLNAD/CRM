		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					<li style="padding: 10px 0 0;"><a href="<c:url value='/index'></c:url>"
					...
					<li><a href="<c:url value='/blank'></c:url>" class="waves-effect"><i
							class="fa fa-columns fa-fw" aria-hidden="true"></i><span
							class="hide-menu">Blank Page</span></a></li>
					<li><a href="<c:url value='/404'></c:url>" class="waves-effect"><i
						...
						<div class="white-box">
							<form action="<c:url value = "/role-add"/>" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input required="required" name="roleName" type="text" placeholder="Tên quyền"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input  name="roleDesc" type="text" placeholder="Mô tả"
											class="form-control form-control-line" />
									</div>
								</div>
								<div class="form-group">
								...
								<div>
									...
									<div class="status" isSuccess="null" >
									</div>
									
									</c:if>
									<c:if test="${isSuccess == true}">
									<div class="status" isSuccess="${isSuccess}" >
